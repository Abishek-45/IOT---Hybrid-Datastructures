            ...
            <div className="flex flex-col h-full overflow-y-auto scrollbar-thin scrollbar-thumb-white scrollbar-track-[#5A90F9]">
                ...
                <div>
                    ...
                    Develop a IOT management system that allows administrators to create, organize, and manage a hierarchical network structure. The system should support the following functionalities:
                        <br></br>1.Allow the addition and removal of various network devices such as routers, switches, wired PCs, and wireless devices.
                        <br></br>2.Devices should be organized in a hierarchical structure based on their physical location (e.g., floor, room). 
                        <br></br>3.Provide a visualization of the network structure, showing the relationships between devices, floors, and rooms.This visualization should be intuitive and easy to understand. 
                        <br></br>4.Implement robust error handling mechanisms to prevent duplicate device names, incorrect configurations, and ensure data integrity within the network structure. 
                        <br></br>5.Support common network operations such as querying device details, modifying device configurations, and troubleshooting network connectivity issues. Incorporate security features to authenticate administrators and restrict unauthorized access to network management functionalities.
                    </p>
                </div>
                <div>
